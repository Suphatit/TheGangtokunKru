...
function executeCommand(command) {
  switch (command) {
      ...
      aboutMe.innerHTML = `
            <div class="txtt">
              <p class="welcome-txt">คำอวยพรถึงคุณครูครับ<br><br>
                ขอให้คุณครูสุขภาพแข็งแรงอยุยืนยาวนะครับ
                <br>
                ด้านการเงินขอให้รวยแล้วรวยอีกมีความสุขกับชีวิตใน
                <br>
                ทุกๆวันนะครับอยู่เป็นร่มร่มโพธิ์ร่มไทรให้เด็กห้องหุ่น
                <br>
                ต่อไปนะครับ
                <br><br>
                คาถาสุขภาพแข็งแรง
    ...
    default:
      content.innerHTML += `ไม่พบ: ${command}, กรุณาลองใหม่.<br>`;
  }
}
